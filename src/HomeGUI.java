...
public class HomeGUI implements ActionListener {
	...
	JButton src;
    JTable jt;
    static Set<Client> local;
	public static void main(String[] args) {
		local =  Client.LocalHost();
		HomeGUI program = new HomeGUI("IPFreely", local);
	}
	public HomeGUI(String name, final Set<Client> local){
		...
		window.setSize(1000, 500);							//set window size
